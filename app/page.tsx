...
export default function HomePage() {
  ...
  "subheading": "Professional car detailing and cleaning services in Seattle, WA for pristine vehicles every time",
  "ctaText": "Get Quote",
  "ctaLink": "/contact"
};
  const features = [
  {
    ...
    "description": "Smart scheduling system that automatically deploys cleaning services based on your business needs and usage patterns."
  }
];
  const services = [
  {
    "title": "Automated Office Cleaning",
    "description": "Complete automated cleaning solutions for offices using advanced robotics and smart scheduling to maintain pristine workspaces efficiently.",
