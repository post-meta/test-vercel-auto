...
export default function HomePage() {
  ...
  const hero = {
  "heading": "Seattle's Premier Auto Cleaning Service You Can Trust",
  "subheading": "Professional car detailing and cleaning services that keep your vehicle spotless and protected year-round.",
  "ctaText": "Get Quote",
  "ctaLink": "/contact"
};
  const features = [
  {
    ...
    "description": "Smart scheduling system that automatically dispatches cleaning teams based on your business needs and peak usage times."
  }
];
  const services = [
  {
    "title": "Automated Office Cleaning",
    "description": "Smart scheduled cleaning systems for offices using advanced automation technology to maintain pristine workspaces with minimal disruption to daily operations.",
    "link": "/services/automated-office-cleaning"
  }
];
